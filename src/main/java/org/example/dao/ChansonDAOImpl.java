...
public class ChansonDAOImpl implements ChansonDAO {
    ...
    @Override
    public Chanson trouverParId(int id) {
        String sql =
    ...
    public void ajouter(Chanson chanson){
        ...
        try (Connection connexion = Connexion.getConnexion();
            ...
            statement.setInt(1, chanson.getId());
            statement.setString(2, chanson.getTitre());
            statement.setString(3, chanson.getArtiste());
            statement.setString(4, chanson.getAlbum());
            statement.setInt(5, chanson.getAnnee());
            statement.setString(6, chanson.getGenre().name());
            statement.setInt(7, chanson.getDuree());
            statement.setInt(8, chanson.getNbr_ecoute());
